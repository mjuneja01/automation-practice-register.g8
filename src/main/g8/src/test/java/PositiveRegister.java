...
public class PositiveRegister {
    public static void main(String[] args) throws InterruptedException {
        //This variable contains the path where chrome driver is located in system
        String locationOfChromeDriver = "/home/knoldus/Documents/mehak";

        System.setProperty("webdriver.chrome.driver", locationOfChromeDriver + "/chromedriver");
        ...
        address.sendKeys("4383  Raccoon Run");
        ...
        //Verify that Registration has been done by asserting the title
